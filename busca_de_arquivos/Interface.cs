...
Programação Orientada a Objetos - Busca de Arquivos (Programa Principal)
...
namespace BuscaDeArquivos{
    ...
    public partial class Interface : Form{
        ...
        private void tbEntrada_KeyDown(object sender, KeyEventArgs e){
            ...
            if(e.KeyCode == Keys.Enter){
                ...
                if(File.Exists( nomeArquivo )){
                    ...
                    tbinformation.Text = obtemInformacaoArquivo(nomeArquivo);
        ...
        private void btfinalizar_Click(object sender, EventArgs e){
            ...
            String arquivoeditado = tbEntrada.Text;

            StreamWriter s = new StreamWriter(tbEntrada.Text);

            if(MessageBox.Show("Salvar Alterações?", "Atenção", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes){

                s.Write("");
                s.Write(tbSaida.Text);
            }
